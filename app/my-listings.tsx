              ...
              {[
                ...
                return (
                  <View key={s.key} style={styles.statItem}>
                    <Text style={styles.statNum}>{cnt}</Text>
...
const styles = StyleSheet.create({
  ...
  addBtn: { width: s(36), height: s(36), borderRadius: s(18), backgroundColor: theme.colors.primary, alignItems: 'center', justifyContent: 'center', ...theme.shadow.brand },
  statsStrip: { flexDirection: 'row', backgroundColor: 'rgba(255,255,255,0.1)', borderRadius: theme.radius.lg, marginTop: s(14), paddingVertical: s(12), paddingHorizontal: s(8) },
  ...
  activeDot: { position: 'absolute', right: s(5), top: s(5), width: s(10), height: s(10), borderRadius: s(5), borderWidth: 1.5, borderColor: '#fff' },
  info: { flex: 1, gap: s(4) },
  title: { fontSize: ms(14.5), fontWeight: '600', lineHeight: ms(19) },
  price: { fontSize: ms(16), fontWeight: '800', fontVariant: ['tabular-nums'] },
  bottomRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  viewRow: { flexDirection: 'row', alignItems: 'center', gap: s(3) },
  viewText: { fontSize: ms(11), fontWeight: '500' },
  emptyWrap: { flex: 1, alignItems: 'center' },
  createBtn: { borderRadius: theme.radius.lg, overflow: 'hidden', marginTop: s(8), ...theme.shadow.brand },
  createFill: { flexDirection: 'row', alignItems: 'center', gap: s(8), paddingHorizontal: s(24), height: s(50) },
